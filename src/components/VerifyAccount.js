        ...
        const verify = async () => {
            ...
            try {
                ...
                if (rs.status === "success") {
                    setStatus("success");
                    setMessage("Your account has been verified 🎉 You can now log in to Ethixion.");
                } else if (rs.status === "expired") {
                    setStatus("error");
                    setMessage(rs.msg || "Link has expired or is invalid. Please register again.");
                } else {
                    setStatus("error");
                    setMessage(rs.msg || "Unable to verify account. Please try again later.");
                }
            } catch (err) {
                setStatus("error");
            ...
            >
                ...
                {status === "error" && (
                    ...
                    >
                        ...
                        <p>{message}</p>
                        <p>You will be redirected in <b>10 seconds</b>...</p>
