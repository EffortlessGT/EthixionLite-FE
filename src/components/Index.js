        ...
        <main>
            ...
            <div className="main-container">
              <div className="desc-container">
                ...
                <p>
                  ...
                  services from unauthorized access and malicious traffic.
                  Acting as a centralized gateway, Ethixion ensures that every
                  incoming request is securely routed, authenticated, and
                  inspected before reaching the origin server. By integrating
                  reverse proxy capabilities, it manages traffic flow
                  efficiently while isolating backend systems from direct
                  exposure, significantly reducing the attack surface. The API
                  Access Security Layer enforces strict authentication and
                  validation mechanisms, ensuring that only authorized clients
            ...
            <div className="timeline">
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  <h3>Act</h3>
                  <p>
                    Threats are blocked, logs generated, and admins alerted.
                  </p>
                </div>
              </div>
            </div>
          ...
          <FadeUpOnScroll>
            <div className="why-ethixion-ul">
              ...
              <ul>
                <li>
                  <i className="fas fa-bolt"></i> Blazing-fast performance
                  powered by Rust, ensuring minimal latency and maximum
                  security.
                </li>
                <li>
                ...
                <li>
                  <i className="fas fa-satellite-dish"></i> Real-time alerts
                  that notify you instantly of suspicious activity.
                </li>
                <li>
